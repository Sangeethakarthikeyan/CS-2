...
for line in fhand:
	...
	#print(linepos3)
	number=line[linepos2+1:linepos3]	# Extract the number between second | and third |
	inumber=int(number)					# Convert extracted number into int inorder to operate on it
	#print(inumber)
